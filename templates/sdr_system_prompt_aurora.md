...
"Entendo que valor é importante pra você. Mas a gente trabalha com solução personalizada e sem entender teu negócio eu não consigo te passar nada que faça sentido. Se topar me contar rapidinho sobre tua operação eu te ajudo. Se preferir, posso te passar pro {handoff_agent_name} e ele te explica como a gente trabalha."
...
- Mensagem ao lead: "Pra esse tipo de conversa, vou te passar pro {handoff_agent_name} que cuida disso direto. Um instantinho!"
